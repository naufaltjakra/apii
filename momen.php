...
if(isset($_GET['id'])){
	...
	$url="http://tolongin.96.lt/v1/momen/".$id;
	...
	$ditolong=$_POST['ditolong'];
	$tanggal=$_POST['tanggal'];
	
	$unique_id=date("d-m-y")."_".uniqid().".jpg";
	
	$path="assets/images/momen/".$unique_id;
	...
	$url="http://tolongin.96.lt/v1/momen";
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_POSTFIELDS => "judul=".$judul."&deskripsi=".$deskripsi."&foto=".$foto."&penolong=".$penolong."&ditolong=".$ditolong."&tanggal=".$tanggal,
	  CURLOPT_HTTPHEADER => array(
		"content-type: application/x-www-form-urlencoded",
		"Authorization: ".$apiKey.""
	  ),
